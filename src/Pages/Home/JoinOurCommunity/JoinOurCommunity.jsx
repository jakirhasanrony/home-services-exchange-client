...
const JoinOurCommunity = () => {
    return (
        <div className="w-full pb-20 my-5 shadow-lg bg-[#f6efea]">
            <div className="mx-auto  py-5">
                <div className="mt-14 mb-8">
                    <h2 className="text-2xl text-amber-700 font-bold text-center">Join Our Community</h2>
            ...
            <div className="card mt-14  shadow-2xl md:w-2/4 p-4 border-4  border-[#cee3db] mx-auto">
                <div className="mx-auto  py-5">
                    <div className="mb-5">
                        <h2 className="text-2xl font-bold text-center">How to Become a Member?</h2>

                    </div>
                    <div className=" mx-auto w-3/4border border-[#cee3db] border-b-2">
                    </div>
                </div>

                <div className="px-5 pb-6">
                    <p className="text-center">Welcome dear Customer, your gateway to a tailored and secure home services exchange. Whether you are a skilled service provider or in need of specific services, our platform connects you with trusted individuals, prioritizing your privacy, satisfaction, and convenience. Sign up, create your profile, and experience a community where you can promote your skills or find the help you require, all while enjoying the peace of mind provided by our protection and guarantees.</p>
                </div>
            </div>
        </div>
    );
