        ...
        <div>
            <div className="carousel w-full h-[600px]">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/5r2WRxs/cropped-3d-rendering-modern-dining-room-living-room-with-luxury-decor.jpg" className="w-full " />
                    <div className="absolute  flex items-center left-0 top-0 h-full bg-gradient-to-r from-[#c2e0ff] to-[#f0f0f0)]">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/b1dXwrH/cropped-man-cleaning-window.jpg" className="w-full " />
                    <div className="absolute  flex items-center left-0 top-0 h-full bg-gradient-to-r from-[#c2e0ff] to-[#f0f0f0)]">
                        <div className="space-y-5">
                            <h2 className="text-2xl md:text-3xl lg:text-6xl mx-auto text-center font-bold w-1/2">HomeHelpHub: Your One-Stop Home Services Exchange </h2>
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/DzQ8gYJ/cropped-top-view-gardening-tools-plants-23-2148175909.jpg" className="w-full " />
                    <div className="absolute  flex items-center left-0 top-0 h-full bg-gradient-to-r from-[#c2e0ff] to-[#f0f0f0)]">
                        <div className="space-y-5">
                            <h2 className="text-2xl md:text-3xl lg:text-6xl mx-auto text-center font-bold w-1/2">HomeHelpHub: Your One-Stop Home Services Exchange </h2>
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/v1xGRtG/cropped-doctor-taking-care-senior-woman-home-23-2148962375.jpg" className="w-full " />
                    <div className="absolute  flex items-center left-0 top-0 h-full bg-gradient-to-r from-[#c2e0ff] to-[#f0f0f0)]">
                        <div className="space-y-5">
                            <h2 className="text-2xl md:text-3xl lg:text-6xl mx-auto text-center font-bold w-1/2">HomeHelpHub: Your One-Stop Home Services Exchange </h2>
